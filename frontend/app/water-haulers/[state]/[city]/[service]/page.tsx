...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.haulagua.com/water-haulers/${state}/${city}/${service}`,
    },
    openGraph: {
      title,
      description,
      url: `https://www.haulagua.com/water-haulers/${state}/${city}/${service}`,
      siteName: "HaulAgua",
      type: "website",
    },
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {haulers.map((hauler) => (
                    <HaulerCard
                      ...
                      refPath={`/water-haulers/${state}/${city}/${service}`}
                    />
                  ))}
                </div>
              </>
